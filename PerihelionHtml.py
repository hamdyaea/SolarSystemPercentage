...
def start():
    startHtml = (
        ...
        + str("<link rel=\"apple-touch-icon\" sizes=\"57x57\" href=\"https://astrometry.ch/pictures/apple-icon-57x57.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"60x60\" href=\"https://astrometry.ch/pictures/apple-icon-60x60.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"72x72\" href=\"https://astrometry.ch/pictures/apple-icon-72x72.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"76x76\" href=\"https://astrometry.ch/pictures/apple-icon-76x76.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"114x114\" href=\"https://astrometry.ch/pictures/apple-icon-114x114.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"120x120\" href=\"https://astrometry.ch/pictures/apple-icon-120x120.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"144x144\" href=\"https://astrometry.ch/pictures/apple-icon-144x144.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"152x152\" href=\"https://astrometry.ch/pictures/apple-icon-152x152.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"180x180\" href=\"https://astrometry.ch/pictures/apple-icon-180x180.png\">")
        + str("<link rel=\"icon\" type=\"image/png\" sizes=\"192x192\"  href=\"https://astrometry.ch/pictures/android-icon-192x192.png\">")
        + str("<link rel=\"icon\" type=\"image/png\" sizes=\"32x32\" href=\"https://astrometry.ch/pictures/favicon-32x32.png\">")
        + str("<link rel=\"icon\" type=\"image/png\" sizes=\"96x96\" href=\"https://astrometry.ch/pictures/favicon-96x96.png\">")
        + str("<link rel=\"icon\" type=\"image/png\" sizes=\"16x16\" href=\"https://astrometry.ch/pictures/favicon-16x16.png\">")
        + str("<link rel=\"manifest\" href=\"https://astrometry.ch/pictures/manifest.json\">")
        + str("<meta name=\"msapplication-TileColor\"content=\"#ffffff\">")
        + str("<meta name=\"msapplication-TileImage\" content=\"https://astrometry.ch/pictures/ms-icon-144x144.png\">")
        + str("<meta name=\"theme-color\" content=\"#ffffff\">")
        + str("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">")
        + str("\n")
        + str("<title>Astrometry </title>")
        + str("\n")
        + str("<link rel=\"stylesheet\" href=\"https://astrometry.ch/css/style.css\" type=\"text/css\">")
        + str("\n")
        + str("</head>")
        + str("\n")
        + str("<body>")
        ...
        + str("<div id=\"logo\">")
        + str("\n")
        + str("<a href=\"index.html\"><img src=\"https://astrometry.ch/pictures/astrometry1.png\" alt=\"LOGO\"></a>")
        + str("\n")
        + str("</div>")
        + str("\n")
...
def neowise(object):
    ...
    with open("/var/www/html/orbital.json", "r") as O:
        ...
        indexFile.write("<li>")
        indexFile.write("\n")
        indexFile.write(str("<img src=\"")+str(picture)+str("\" alt=\"Img\" height=\"")+str(H)+str("\" width=\"")+str(W)+str("\">"))
        indexFile.write("\n")
        indexFile.write(str("<h3><a href=\"blog.html\">")+str(orbit[object][0]["info"])+str(" : ")+str(object)+str("</a></h3><br/>"))
        indexFile.write("\n")
        indexFile.write("<p>")
        indexFile.write("\n")
        indexFile.write(str("Day of the year : Day ")+str(new)+str("<br />Year progress : ")+str(Percentage.objectResult)+str("%")+str("<br />")+str("Percent of this year : ")+str(barre))
        indexFile.write("\n")
        indexFile.write("</p>")
        indexFile.write("\n")
        indexFile.write("</li>")
...
def Earth():
    ...
    with open("/var/www/html/orbital.json", "r") as O:
        ...
        barre = ("["+ "#" * int((25 / 100) * percent) + "_" * int((25 / 100) * (100 - percent))+ "]")
        ...
        indexFile.write(str("<img src=\"")+str(picture)+str("\" alt=\"Img\" height=\"")+str(H)+str("\" width=\"")+str(W)+str("\">"))
        indexFile.write("\n")
        indexFile.write(str("<h3><a href=\"blog.html\">")+str("Planet : Earth")+str("</a></h3><br/>"))
        indexFile.write("\n")
        indexFile.write("<p>")
        indexFile.write("\n")
        indexFile.write(str("Day of the year : Day ")+str(new)+str("<br />Year progress : ")+str(Percentage.EarthResult)+str("%")+ str("<br />")+str("Percent of this year : ")+str(barre))
        indexFile.write("\n")
        indexFile.write("</p>")
        indexFile.write("\n")
        indexFile.write("</li>")
...
indexFile.write("<li>")
indexFile.write("\n")
indexFile.write("<a href=\"https://www.facebook.com/Astrometrych-106592170853278/\" target=\"_blank\">Facebook</a>")
indexFile.write("\n")
indexFile.write("</li>")
indexFile.write("\n")
indexFile.write("<li>")
indexFile.write("\n")
indexFile.write("<a href=\"https://twitter.com/intent/follow?original_referer=https%3A%2F%2Fastrometry.ch%2F&ref_src=twsrc%5Etfw&screen_name=astrometry_ch&tw_p=followbutton\" target=\"_blank\">Twitter</a>")
indexFile.write("\n")
indexFile.write("</li>")
indexFile.write("\n")
indexFile.write("</ul>")
...
indexFile.write("<li>")
indexFile.write("\n")
indexFile.write("<a href=\"https://github.com/hamdyaea/SolarSystemPercentage\">Github of Solar system percentage</a>")
indexFile.write("\n")
indexFile.write("</li>")
indexFile.write("\n")
indexFile.write("<li><p>This page is licensed under a")
indexFile.write("\n")
indexFile.write("<a href=\"https://creativecommons.org/licenses/by-nd/4.0/\">Creative Commons Attribution-NoDerivatives 4.0 International License</a></p>")
indexFile.write("\n")
indexFile.write("</li>")
indexFile.write("\n")
indexFile.write("</ul>")
...
indexFile.write("\n")
indexFile.write("<h4>Developer - Senior linux System Engineer : Hamdy Abou El Anein</h4>")
indexFile.write("\n")
