...
def start():
    startHtml = (
        ...
        + str("<link rel=\"apple-touch-icon\" sizes=\"57x57\" href=\"http://astrometry.ch/pictures/apple-icon-57x57.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"60x60\" href=\"http://astrometry.ch/pictures/apple-icon-60x60.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"72x72\" href=\"http://astrometry.ch/pictures/apple-icon-72x72.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"76x76\" href=\"http://astrometry.ch/pictures/apple-icon-76x76.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"114x114\" href=\"http://astrometry.ch/pictures/apple-icon-114x114.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"120x120\" href=\"http://astrometry.ch/pictures/apple-icon-120x120.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"144x144\" href=\"http://astrometry.ch/pictures/apple-icon-144x144.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"152x152\" href=\"http://astrometry.ch/pictures/apple-icon-152x152.png\">")
        + str("<link rel=\"apple-touch-icon\" sizes=\"180x180\" href=\"http://astrometry.ch/pictures/apple-icon-180x180.png\">")
        + str("<link rel=\"icon\" type=\"image/png\" sizes=\"192x192\"  href=\"http://astrometry.ch/pictures/android-icon-192x192.png\">")
        + str("<link rel=\"icon\" type=\"image/png\" sizes=\"32x32\" href=\"http://astrometry.ch/pictures/favicon-32x32.png\">")
        + str("<link rel=\"icon\" type=\"image/png\" sizes=\"96x96\" href=\"http://astrometry.ch/pictures/favicon-96x96.png\">")
        + str("<link rel=\"icon\" type=\"image/png\" sizes=\"16x16\" href=\"http://astrometry.ch/pictures/favicon-16x16.png\">")
        + str("<link rel=\"manifest\" href=\"http://astrometry.ch/pictures/manifest.json\">")
        + str("<meta name=\"msapplication-TileColor\"content=\"#ffffff\">")
        + str("<meta name=\"msapplication-TileImage\" content=\"http://astrometry.ch/pictures/ms-icon-144x144.png\">")
        + str("<meta name=\"theme-color\" content=\"#ffffff\">")
        + str("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">")
        + str("\n")
        + str("<title>Astrometry </title>")
        + str("\n")
        + str("<link rel=\"stylesheet\" href=\"css/style.css\" type=\"text/css\">")
        + str("\n")
        + str("</head>")
        + str("\n")
        + str("<body>")
        ...
        + str("<div id=\"logo\">")
        + str("\n")
        + str("<a href=\"index.html\"><img src=\"pictures/astrometry1.png\" alt=\"LOGO\"></a>")
        + str("\n")
        + str("</div>")
        + str("\n")
