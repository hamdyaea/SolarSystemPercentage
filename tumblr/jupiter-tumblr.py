...
client.create_photo(blogName, state="published", tags=[Percentage.JupiterHTML + Percentage.barrJupiterHTML], format="markdown",
                    data=["/var/www/html/pictures/jupiter.jpg"],
