...
client.create_photo(blogName, state="published", tags=[Percentage.HalleyHTML + Percentage.barrHalleyHTML], format="markdown",
                    data=["/var/www/html/pictures/halley.jpg"],
