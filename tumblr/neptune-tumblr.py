...
client.create_photo(blogName, state="published", tags=[Percentage.NeptuneHTML + Percentage.barrNeptuneHTML], format="markdown",
                    data=["/var/www/html/pictures/neptune.jpg"],
