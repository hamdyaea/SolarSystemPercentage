...
client.create_photo(blogName, state="published", tags=[Percentage.MercuryHTML + Percentage.barrMercuryHTML], format="markdown",
                    data=["/var/www/html/pictures/mercury.png"],
