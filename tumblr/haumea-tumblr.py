...
client.create_photo(blogName, state="published", tags=[Percentage.HaumeaHTML + Percentage.barrHaumeaHTML], format="markdown",
                    data=["/var/www/html/pictures/haumea.jpg"],
