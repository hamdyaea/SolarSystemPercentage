...
client.create_photo(blogName, state="published", tags=[Percentage.MakemakeHTML + Percentage.barrMakemakeHTML], format="markdown",
                    data=["/var/www/html/pictures/makemake.jpg"],
