...
def Earth():
        ...
        d1 = date(Percentage.current_year, Percentage.thisMonth, Percentage.today) # Year, month, day
...
def Moon(): # d0 = first perihelion , d1 = today , d2 = next perihelion
    with open("Orbit.json", "r") as O:
        ...
        for i in thisYear:
            ...
            d0 = date(d0Year, d0Month, d0Day)
            d1 = date(Percentage.current_year, Percentage.thisMonth, Percentage.today)
            if d0 >= d1-timedelta(days=30) and d0 <= d1: # i is bigger or equal today - 30 days and smaller or equal today : First day of rotation
        ...
        for i in thisYear:
            ...
            d0 = date(d0Year, d0Month, d0Day)
            d1 = date(Percentage.current_year, Percentage.thisMonth, Percentage.today)
            if d0 <= d1+timedelta(days=30) and d0 >= d1: # i is smaller or equal today + 30 days and bigger or equalt today : Next Perihelion
